% Brief expl
This appendix reports all graphs and tables related to all the reading experiments conducted. Results are reported first expressed as latency (measured during the experiments), then as throughput (computed from the latency and table size).
...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
        \captionof{table}{Read latency experiment results performed with 1 \glstext{CPU} core}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \caption{Histogram in log-scale of the read latency experiment results performed with 1 \glstext{CPU} core}
...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
        \captionof{table}{Read latency experiment results performed with 2 \glstext{CPU} cores}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \caption{Histogram in log-scale of the read latency experiment results performed with 2 \glstext{CPU} cores}
...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
        \captionof{table}{Read latency experiment results performed with 4 \glstext{CPU} cores}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \caption{Histogram in log-scale of the read latency experiment results performed with 4 \glstext{CPU} cores}
...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
        \captionof{table}{Read latency experiment results performed with 8 \glstext{CPU} cores}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \caption{Histogram in log-scale of the read latency experiment results performed with 8 \glstext{CPU} cores}
...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
        \captionof{table}{Read throughput experiment results performed with 1 \glstext{CPU} core}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \caption{Histogram in log-scale of the read throughput experiment results performed with 1 \glstext{CPU} core}
...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
        \captionof{table}{Read throughput experiment results performed with 2 \glstext{CPU} cores}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \caption{Histogram in log-scale of the read throughput experiment results performed with 2 \glstext{CPU} cores}
...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
        \captionof{table}{Read throughput experiment results performed with 4 \glstext{CPU} cores}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \caption{Histogram in log-scale of the read throughput experiment results performed with 4 \glstext{CPU} cores}
...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
        \captionof{table}{Read throughput experiment results performed with 8 \glstext{CPU} cores}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \caption{Histogram in log-scale of the read throughput experiment results performed with 8 \glstext{CPU} cores}

...
All changes were applied to copies (colloquially defined as "fork") of the open-source repositories related to this project (delta-rs, hdfs-native-object-store, hdfs-native). These changes are available on the author's repository \cite{manfrediSilemoHdfsnative2024, manfrediSilemoHdfsnativeobjectstore2024, manfrediSilemoDeltars2024}.
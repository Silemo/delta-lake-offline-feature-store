...
The following two sections detail the major problems and issues solved by the two code contributions, explaining more in-depth the libraries architecture and dependencies.

...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
        \captionof{table}{Write latency experiment results compared across multiple \glstext{CPU} configurations}
...
\begin{figure}
    \centering
    \begin{minipage}[b]{\textwidth}
        \captionof{table}{Write throughput experiment results compared across multiple \glstext{CPU} configurations}
...
\todo[inline]{Fix this ref to non-existing table+figure}
...
\begin{figure}
    \centering
    \begin{minipage}[b]{\textwidth}
        \captionof{table}{Read latency experiment results compared across multiple \glstext{CPU} configurations}
...
\begin{figure}
    \centering
    \begin{minipage}[b]{\textwidth}
        \captionof{table}{Read throughput experiment results compared across multiple \glstext{CPU} configurations}
...
\begin{figure}
    \centering
    \begin{minipage}[b]{\textwidth}
        \captionof{table}{Contributions to the write latency of the upload and materialization steps in the legacy pipeline and its change at different \glstext{CPU} configurations}

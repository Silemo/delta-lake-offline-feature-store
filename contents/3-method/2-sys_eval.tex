...
Additionally, during the writing experiments performed using the legacy Spark pipeline the contribution of different parts of the process will be measured: namely the upload time and materialization time, dichotomy explained in Section \todo[inline]{Ref here time breakdown expl.}. This will serve to verify how different parts of the legacy pipeline scaled with table sizes, and if Spark was the bottleneck of the architecture.

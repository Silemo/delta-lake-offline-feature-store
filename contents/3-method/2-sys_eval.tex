...
% Here explain how the readability and validity of the collected data were addressed. Mainly here the bootstrapping method needs to 

explained and how it achieves getting a CI without making assumption on the data distribution.

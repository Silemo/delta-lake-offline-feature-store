...
The research paradigm of the system implementation section of this thesis is positivist, believing that reality is certain and it can be measured and understood. This thought declined in the context of the development process, means that the new system requirements can be defined and implementation errors can be outlined, understood and if possible fixed. This approach lead to a strict definition of the development process depending on functional requirements that must be fulfilled.
